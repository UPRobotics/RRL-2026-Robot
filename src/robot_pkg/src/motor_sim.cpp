...
static const std::vector<SimMotor> ALL_MOTORS = {
    {"/body_left_flipper/telemetry",  0, "Flipper Trasero",   0, false, 0, 0.0f, 0.0f},
    {"/body_left/telemetry",          1, "Track Izquierdo",   0, false, 0, 0.0f, 0.0f},
    {"/body_right/telemetry",         2, "Track Derecho",     0, true,  0, 0.0f, 0.0f},
    {"/body_right_flipper/telemetry", 3, "Flipper Delantero", 0, false, 0, 0.0f, 0.0f},
    {"/arm_hip/telemetry",            4, "Cadera",            0, false, 0, 0.0f, 0.0f},
    {"/arm_shoulder/telemetry",       5, "Hombro",            1, false, 0, 0.0f, 0.0f},
    {"/arm_elbow/telemetry",          6, "Codo",              1, false, 0, 0.0f, 0.0f},
    {"/arm_roll/telemetry",           7, "Roll",              0, false, 0, 0.0f, 0.0f},
    {"/arm_pitch/telemetry",          8, "Pitch",             1, false, 0, 0.0f, 0.0f},
    {"/arm_claw/telemetry",           9, "Grip",              1, false, 0, 0.0f, 0.0f},
};
